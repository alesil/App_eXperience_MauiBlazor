...
internal partial class SatService
{
    ...
    internal partial string ComunicarCertificadoIcpbrasil(int num_session, string activation_code, string transaction_data) => throw new NotImplementedException();
